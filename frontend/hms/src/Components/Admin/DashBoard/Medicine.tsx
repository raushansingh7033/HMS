const medicines = [
  { name: "Paracetamol", dosage: "500mg", stock: 120, manufacturer: "ABC Pharma" },
  { name: "Ibuprofen", dosage: "200mg", stock: 80, manufacturer: "XYZ Labs" },
  { name: "Amoxicillin", dosage: "250mg", stock: 50, manufacturer: "HealWell Pharma" },
  { name: "Cetirizine", dosage: "10mg", stock: 150, manufacturer: "MediCare Ltd." },
  { name: "Vitamin C", dosage: "500mg", stock: 200, manufacturer: "NutriHealth" },
  { name: "Metformin", dosage: "500mg", stock: 90, manufacturer: "LifeCare Pharma" },
  { name: "Aspirin", dosage: "75mg", stock: 60, manufacturer: "GoodHealth Labs" },
];
