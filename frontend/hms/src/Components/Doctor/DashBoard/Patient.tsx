...
const Patient = () => {
  return (
    <div className="p-3  rounded-xl bg-red-100 shadow-xl flex flex-col gap-3">
...
const Card = (patient: any) => {
  return (
    <div className="p-3 mb-3 bg-red-100  border border-l-4 border-violet-500 shadow-md rounded-xl flex justify-between">
      <div>
